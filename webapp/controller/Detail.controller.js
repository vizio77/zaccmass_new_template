...
sap.ui.define([
	...
	return Controller.extend("zsap.com.mef.bilancio.formazione.accmass.controller.Detail", {
		formatter: formatter,
		...
		onPressMatchCodeFragment: function (oEvent) {
			...
			if(!this[value]) {
				Fragment.load({
					name:"zsap.com.mef.bilancio.formazione.accmass.view.fragment." + value,
					controller: this
				}).then(oDialog => {
					this[value] = oDialog;
		...
		onHelpValueSottoStrumento: function () {
			...
			if(!this.oDialogHVSottoStrumento) {
				...
				Fragment.load({
					name:"zsap.com.mef.bilancio.formazione.accmass.view.fragment.HelpValueSottostrumento",
					controller: this
				}).then(oDialog => {
		...
		onSottostrumento: function () {
			...
			if(!this._oDialog){
				this._oDialog = sap.ui.xmlfragment(
					"zsap.com.mef.bilancio.formazione.accmass.view.fragment.Sottostrumento",
					this);
