sap.ui.define([
	...
	return Controller.extend("zsap.com.mef.bilancio.formazione.accmass.controller.Home", {
		formatter: formatter,
		...
		handleAddAccantonamenti: function (oEvent) {
			...
			if (!this._handleAddAccantonamenti) {
				this._handleAddAccantonamenti = sap.ui.xmlfragment("zsap.com.mef.bilancio.formazione.accmass.view.fragment.AddAccantonamenti", this);
